...
- 行動デザインが一番高く、読書メモ：習慣の本は北側の床に接している。床のノードは柱なし・接地影、浮いたノードは目立つ柱と 1 段ごとの目盛り、影は同じ大きさで柱の下端。
